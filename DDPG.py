"""
Adapted from: https://github.com/nikhilbarhate99/TD3-PyTorch-BipedalWalker-v2
"""
...
class DDPG:
    ...
    def learn(self, replay_buffer, batch_size, gamma, tau, policy_noise, noise_clip):
        ...
        loss_Q1 = F.mse_loss(q1_value, q_target)
        ...
        loss_Q2 = F.mse_loss(q2_value, q_target)
